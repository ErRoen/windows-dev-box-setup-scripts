...
|<a href='http://boxstarter.org/package/url?https://raw.githubusercontent.com/ErRoen/windows-dev-box-setup-scripts/master/dev_app_desktop_.NET.ps1'>.NET Desktop App</a>     | Windows Desktop App Development (Visual Studio, Windows SDK, .NET (WPF and Winforms)) |
